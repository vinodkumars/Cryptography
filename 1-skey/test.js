...
function test_chain(constructor, seed, num_iterations) {
  ...
  console.log("[STATS] Number of iterations: "+chain.state.num_iterations);
  console.log("[STATS] Hashes in initialize: "+chain.state.initializeHashCount);
  console.log("[STATS] Total hashes in advance: "+chain.state.hashCount);
  console.log("[STATS] Amortised hash count: "+chain.state.hashCount/chain.state.num_iterations);
